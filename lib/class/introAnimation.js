...
var textAnimationTest_1 = require("./textAnimationTest");
    ...
    function IntroAnimation(allGears) {
        ...
        this.rise = function () {
            ...
            if (_this.backgroundHeight > window.window.innerHeight / 2) {
                ...
                //* show text
                setTimeout(function () {
                    var firstNameAnimation = new textAnimationTest_1.textAnimTest('#firstName', 'Léo', null, 12);
                    var lastName = new textAnimationTest_1.textAnimTest('#lastName', 'Gatille', 80, 5);
                    var subtitle = new textAnimationTest_1.textAnimTest('#subtitle', 'Developpement, Design, Illustration', 350, 2);
                    var animatedText = new Promise(function (resolve) {
                    ...
                    Promise.resolve(function () { return animatedText; });
                }, 300);
