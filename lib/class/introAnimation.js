    ...
    function IntroAnimation(allGears) {
        ...
        this.rise = function () {
            ...
            if (_this.backgroundHeight > window.window.innerHeight / 2) {
                ...
                //* show text
                var firstNameAnimation_1 = new textAnimationTest_1.textAnimTest('#firstName', 'Léo');
                var lastName_1 = new textAnimationTest_1.textAnimTest('#lastName', 'Gatille', 100);
                var animatedText = new Promise(function (resolve) {
                    resolve(firstNameAnimation_1.animationDecryptText());
                }).then(function () {
                    lastName_1.animationDecryptText();
                });
